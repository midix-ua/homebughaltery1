...
public class Spending {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(id, spending.id) && Objects.equals(account, spending.account) && Objects.equals(monthly_spending, spending.monthly_spending) && Objects.equals(date, spending.date);
    }

    @Override
    public int hashCode() {
        return Objects.hash(id, account, monthly_spending, date);
    }
